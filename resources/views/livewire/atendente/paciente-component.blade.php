...
<div>
        ...
        <div class="content-wrapper pb-0">
          <div class="page-header flex-wrap">
            <div  class="header-left">
              <h4 class="text-muted text-uppercase"><i class="fa-solid fa-bed-pulse"></i> Pacientes</h4>
            </div>
                    ...
                    <table class="table table-bordered table-hover text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if (
                                            $item->dataDeNascimento == null ||
                                            $item->idade == null ||
                                            $item->nacionalidade == null ||
                                            $item->nomeDoPai == null ||
                                            $item->nomeDaMae == null ||
                                            $item->contribuente  == null ||
                                            $item->grupoSanguinio == null ||
                                            $item->provincia == null ||
                                            $item->municipio == null ||
                                            $item->bairro == null ||
                                            $item->endereco == null ||
                                    ...
                                    <button type="button" wire:click="editar({{$item->id}})" data-bs-toggle="modal" data-bs-target="#paciente" class="btn btn-sm btn-outline-success" title="Completar Informações de Paciente"> <i class="fa fa-check"></i></button>
    ...
    @include('livewire.atendente.modal.paciente')
</div>
<script>
