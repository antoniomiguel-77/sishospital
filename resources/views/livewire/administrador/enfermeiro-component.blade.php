...
<div>
        ...
        <div class="content-wrapper pb-0">
          <div class="page-header flex-wrap">
            <div  class="header-left">
              <h4 class="text-muted text-uppercase"><i class="fa-solid fa-user-doctor"></i> Enfermeiros</h4>
            </div>
                    ...
                    <table class="table table-bordered table-hover text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" wire:click="editar({{$item->id}})" data-bs-toggle="modal" data-bs-target="#medicos" class="btn btn-sm btn-outline-primary"> <i class="fa fa-info-edit"></i></button>
    ...
    @include('livewire.administrador.modal.enfermeiro')
</div>
<script>
