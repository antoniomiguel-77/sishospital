...
<div>
        ...
        <div class="content-wrapper pb-0">
          <div class="page-header flex-wrap">
            <div  class="header-left">
              <h4 class="text-muted text-uppercase"><i class="fa-solid fa-stethoscope"></i> Especialidades</h4>
            </div>

            <div  class="header-right d-flex flex-wrap mt-md-2 mt-lg-0">
              <button data-bs-toggle="modal" data-bs-target="#especialidade" type="button" class="btn btn-primary mt-2 mt-sm-0 btn-icon-text">
                    ...
                    <table class="table table-bordered table-hover text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" wire:click="editar({{$item->id}})" data-bs-toggle="modal" data-bs-target="#especialidade" class="btn btn-sm btn-outline-primary"> <i class="fa fa-edit"></i></button>
                        ...
                        @else
                            <tr>
                                <td colspan="2" class="text-uppercase text-center">A consulta não retorno valor</td>
                            </tr>
                        @endif
    ...
    @include('livewire.administrador.modal.especialidade')
</div>
<script>
