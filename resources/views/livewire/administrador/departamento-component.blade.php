        ...
        <div class="content-wrapper pb-0">
          <div class="page-header flex-wrap">
            <div  class="header-left">
              <h4 class="text-muted text-uppercase"><i class="fa fa-hospital-user"></i> Departamentos</h4>
            </div>

            <div  class="header-right d-flex flex-wrap mt-md-2 mt-lg-0">
              <button data-bs-toggle="modal" data-bs-target="#departamento" type="button" class="btn btn-primary mt-2 mt-sm-0 btn-icon-text">
              ...
              <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover text-center">
                        ...
                        <tbody>
                            @if (isset($departamentos) and $departamentos->count() > 0)
                                @foreach ($departamentos as $item)
                            <tr>
                                <td>{{$item->descricao}}</td>
                                <td>{{$item->telefone}}</td>
                                <td>
                                    <button type="button" wire:click="editar({{$item->id}})" data-bs-toggle="modal" data-bs-target="#departamento" class="btn btn-sm btn-outline-primary"> <i class="fa fa-edit"></i></button>
